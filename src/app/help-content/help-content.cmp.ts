...
const HELP_DATA: Record<string, { title: string, description: string }> = {
  ...
  'payrollPaymentMonth': {
    title: '給与支給月',
    description: '給与管理画面での給与データの表示月を指定します。社会保険料徴収月の設定とは独立です。\n当月：月次管理の計算月と給与管理の支給月が一致します。\n翌月：月次管理の計算月の翌月が給与管理の支給月になります。',
  },
  'socialInsuranceCollectionMonth': {
    title: '社会保険料徴収月',
    description: '社会保険料の徴収月を指定します。原則は翌月徴収です。\n当月：月次管理の計算月と社会保険料徴収月が一致します。\n翌月：月次管理の計算月の翌月が社会保険料徴収月になります。\n翌々月：月次管理の計算月の翌々月が社会保険料徴収月になります。',
  },
  'employeesImport': {
    title: '社員情報のインポート',
