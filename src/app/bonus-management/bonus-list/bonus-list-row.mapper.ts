...
import { extractBonusAmounts, sumBonusAmounts } from './bonus-data.util';
...
function bonusTotal(row: BonusListRow): number {
  return sumBonusAmounts(row.bonus);
}
